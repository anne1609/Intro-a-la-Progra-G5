     ...
     while(ini<fin){
         ...
         System.out.println();
           ...
           if(ini+1<fin-2){ 
             ...
             System.out.print(mat[ini+1][ini+1] +"\t");
             System.out.print(mat[ini+1][fin-2] +"\t");
             System.out.print(mat[fin-2][fin-2] +"\t");
             System.out.print(mat[fin-2][ini+1] +"\t");
             System.out.println();
            }
         ini=ini+2;
         fin=fin-2;
