public class Espiralv3
{
    int tam;

    public Espiralv3(int tam){
        this.tam=tam;
    }
    ...
    int[][] ordenarMatrizEspiral(int[][] mat){
        //Llamada a algunos metodos antes de hacer el espiral
        int[] copia=llenarCopia(mat);
        copia=ordenarBurbuja(copia);
        //Espiral
        int ini=0;
        int fin=tam;
        int mitad=tam/2;
